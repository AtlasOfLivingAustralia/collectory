...
<div class="container">
    ...
    <ul>
        <li><g:link controller="apiKeyLog" action="roleTest" params="[dest: '/ws/contacts/1']">ROLE_ADMIN required by /data/contacts</g:link></li>
        <li><g:link controller="apiKeyLog" action="roleTest" params="[dest: '/ws/contacts/1', method: 'POST']">ROLE_EDITOR required</g:link></li>
    </ul>
