        ...
        <p>
            <g:if test="${cf?.contact?.publish}">
                ...
                <g:if test="${cf?.contact?.phone}">
                    <g:message code="public.show.contacts.phone" default="phone"/>: ${cf?.contact?.phone}<br/>
                </g:if>
                <g:if test="${cf?.contact?.fax}">
                    <g:message code="public.show.contacts.phone" default="phone"/>: ${cf?.contact?.fax}<br/>
                </g:if>
                <cl:emailLink email="${cf?.contact?.email}">
                    <g:message code="public.show.contacts.email" default="email this contact"/>
                </cl:emailLink>
            </g:if>
        </p>
      </div>
