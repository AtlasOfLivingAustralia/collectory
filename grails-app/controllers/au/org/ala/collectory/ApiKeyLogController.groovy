...
class ApiKeyLogController {
    ...
    @AlaSecured(value = 'ROLE_ADMIN', redirectController = 'public', redirectAction = 'map', message = "You don’t have permission to view this statistics page for legacy API key usage.")
    def index() {
